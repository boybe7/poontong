...
<fieldset class="scheduler-border">
					...
					$this->widget('bootstrap.widgets.TbButton', array(
			              ...
			              'htmlOptions'=>array(
						    ...
						    'onclick'=>'
								...
								$.ajax({
										type: "POST",
										url: "' .CController::createUrl('SellMaterial/CreateItemDetailTemp'). '",										
										data: {
	...
	<div>
		...
		$modelTemp = new SellMaterialDetailTemp;
							...
							'material_id'=>array(
					  	    ...
					  	    'price_unit'=>array(
								...
								'editable' => array( //editable section
									...
									'title'=>'แก้ไข ',
									'url' => $this->createUrl('SellMaterial/updateDetailTemp'),
					  	    ...
					  	    array(
								...
								'buttons'=>array(
										'delete'=>array(
											'url'=>'Yii::app()->createUrl("SellMaterial/deleteDetailTemp", array("id"=>$data->id))',	
