...
/**
 * This is the model class for table "buy_chemical".
 *
 * The followings are the available columns in table 'buy_chemical':
 * @property integer $id
 ...
 */
class BuyChemical extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('price, buy_date, volume, supplier, chemical_id, user_id, site_id', 'required'),
			array('chemical_id, user_id, site_id', 'numerical', 'integerOnly'=>true),
			array('price, volume', 'length', 'max'=>10),
			array('supplier, note', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, price, buy_date, volume, supplier, chemical_id, user_id, site_id, note', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return BuyChemical the static model class
	 */
