...
/**
 * This is the model class for table "sell_material_detail_temp".
 *
 * The followings are the available columns in table 'sell_material_detail_temp':
 * @property integer $id
 ...
 */
class SellMaterialDetailTemp extends CActiveRecord
{
	/**
	...
	{
		return 'sell_material_detail_temp';
	}
	...
	public function rules()
	{
		...
		return array(
			array('material_id, amount, price_unit, price_net, sell_id, user_id', 'required'),
			array('material_id, sell_id, user_id, flag', 'numerical', 'integerOnly'=>true),
			...
			array('id, material_id, amount, price_unit, price_net, sell_id, user_id, flag, weight_in, weight_out', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SellMaterialDetailTemp the static model class
	 */
