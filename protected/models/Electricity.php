 ...
 *
 * The followings are the available columns in table 'electricity':
 * @property integer $id
 ...
 */
class Electricity extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('hour, unit, create_date, site_id', 'required'),
			array('site_id', 'numerical', 'integerOnly'=>true),
			array('hour, unit', 'length', 'max'=>15),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, hour, unit, create_date, site_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Electricity the static model class
	 */
